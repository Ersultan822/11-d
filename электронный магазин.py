...
client = Client(1, "Ereke", "ereke@mail.com", "Алматы", "+77712345678")
admin = Admin(100, "Admin1", "admin@mail.com", "Алматы", "+77700011122")

client.register()
admin.log_action("Система запущена")

category1 = Category(10, "Электроника", "Смартфоны и аксессуары")
product1 = Product(101, "Смартфон X", "Новый смартфон", 120000, 10, category1)
product2 = Product(102, "Наушники Y", "Беспроводные наушники", 20000, 15, category1)

product1.create()
product2.create()

promo = PromoCode("SALE10", 10)  # 10% скидка
